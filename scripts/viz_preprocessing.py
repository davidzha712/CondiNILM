...
def run_preprocessing_tab():
    ...
    if data_source == "Synthetic":
        ...
        if load_clicked or 'X_real' in st.session_state:
            ...
            st.write(f"Data Shape: `{X_data.shape}`")
